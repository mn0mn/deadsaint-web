  ...
  return (
    <div className="account-page">
      ...
      <main className="account-content">
        {activeTab === "orders" && (
          <section>
            <div className="account-section-heading">
              <div>
                <span className="account-section-index">01 /</span>
            ...
            <div className="account-orders">
              {orders.map((order) => (
                <div className="account-order" key={order.id}>
                  ...
                  <div className={`account-order-status ${order.status.toLowerCase()}`}>
                    {order.status}
                  </div>
                </div>
              ))}
        ...
        {activeTab === "details" && (
          <section>
            <div className="account-section-heading">
              <div>
                <span className="account-section-index">02 /</span>
                <h2>YOUR DETAILS</h2>
              </div>
            </div>
            ...
            <div className="account-info-grid">
              <article className="account-info-card">
                ...
                <a className="account-edit" href="#">EDIT DETAILS ↗</a>
              </article>
        ...
        {activeTab === "addresses" && (
          <section>
            <div className="account-section-heading">
              <div>
                <span className="account-section-index">03 /</span>
                <h2>WHERE TO SEND THE DEAD</h2>
              </div>
            </div>
        ...
        {activeTab === "settings" && (
          <section>
            <div className="account-section-heading">
              <div>
                <span className="account-section-index">04 /</span>
                <h2>SETTINGS</h2>
              </div>
            </div>
            ...
            <div className="account-setting-list">
              <div className="account-setting">
                <div>
                  ...
                  <span>Receive DeadSaint transmissions.</span>
                </div>
                <span className="account-toggle" aria-hidden="true" />
              </div>

              <div className="account-setting">
                <div>
                  <strong>ORDER UPDATES</strong>
                  <span>Get notified when your package moves.</span>
                </div>
                <span className="account-toggle" aria-hidden="true" />
              </div>
              ...
              <div className="account-setting">
                <div>
                  ...
                  <span>This one is permanent. Obviously.</span>
                </div>
                <button className="account-actions button" type="button">
                  DELETE ↗
                </button>
              </div>
            </div>
      ...
      <footer className="account-footer">
        <p>
          THIS FILE IS PROPERTY OF DEADSAINT.
          <br />
          HANDLE WITH QUESTIONABLE CARE.
        </p>
